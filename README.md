...
flowchart LR
    ...
    subgraph Local["Local Environment"]
        ...
        LocalService["Local Service<br/>Go Service"]
    ...
    LocalApp --> LocalService
    LocalService --> Project
    LocalService --> AIProviders
    LocalService --> MCPs
    LocalService <--> CloudAPI
...
| Repository                                                                               | Purpose                                                                                                               |
| ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [`sweorchestrai-overview`](https://github.com/SWEOrchestrAI/sweorchestrai-overview)           | Documentation hub, architecture, roadmap, diagrams, technical decisions, screenshots, and portfolio presentation.     |
| [`sweorchestrai-local-app`](https://github.com/SWEOrchestrAI/sweorchestrai-local-app)         | Desktop application built with Electron + React. Provides the local user interface.                                   |
| [`sweorchestrai-local-service`](https://github.com/SWEOrchestrAI/sweorchestrai-local-service) | Local service service built in Go. Handles project access, local execution, tool communication, and AI orchestration. |
| [`sweorchestrai-cloud-web`](https://github.com/SWEOrchestrAI/sweorchestrai-cloud-web)         | Cloud web frontend for dashboards, project visibility, roadmap management, and configuration.                         |
| [`sweorchestrai-cloud-api`](https://github.com/SWEOrchestrAI/sweorchestrai-cloud-api)         | Cloud backend API and database layer. Acts as the contract center of the system.                                      |
...
* Local service status and configuration.
...
The local service is the bridge between the desktop app, the local machine, target repositories, MCP servers, and AI providers.
...
sequenceDiagram
    ...
    App->>Service: Start task execution
    Service->>Project: Read project context
    Service->>AI: Send structured task context
    AI-->>Service: Return proposed actions
    Service->>Project: Apply or stage changes
    Service->>API: Sync execution metadata
...
4. Execute an AI-assisted task through the local service.
